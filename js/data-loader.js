...
function populateSkills(skillsData) {
    ...
    const otherSkillsContainer = document.querySelector('.skill-tags');
    
    if (skillsGrid) {
        skillsGrid.innerHTML = '';
        skillsData.core.forEach(skill => {
            skillsGrid.innerHTML += `
    ...
    if (otherSkillsContainer) {
        otherSkillsContainer.innerHTML = '';
        skillsData.other.forEach(skill => {
            otherSkillsContainer.innerHTML += `<span class="skill-tag">${skill}</span>`;
        });
    }
}
